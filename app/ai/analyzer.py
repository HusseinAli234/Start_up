    ...
    generate_content_config = types.GenerateContentConfig(
        ...
        system_instruction=[
            types.Part.from_text(text="""Ты — эксперт по анализу и структурированию данных из резюме. Твоя задача — взять текст резюме и преобразовать его в строго форматированный JSON-объект для хранения в базе данных:
                , HARD скиллы ОЦЕНИВАЙ ОЧЕНЬ СТРОГО,ЛУЧШЕ ПОСТАВЬ НИЖЕ ЧЕМ ВЫШЕ РЕАЛЬНОГО, а SOFT скилы оценивай просто СТРОГО, не делай описание длинным , пиши только суть , если просто упоминается навык то ставь ниже 20,ТАКЖЕ В КОНЦЕ РЕЗЮМЕ ТЕБЕ ДАНА ИНФОРМАЦИЯ ИЗ СОЦ СЕТЕЙ ПРО КАНДИДАТА"""),
        ],
    )
