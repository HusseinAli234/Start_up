...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000","http://localhost","https://api.sand-box.pp.ua","http://api.sand-box.pp.ua","https://husseinali234.github.io","https://sandbox-front-dev-390134393019.us-central1.run.app","https://sandbox.sdinis.org"],
...
async def background_task(resume_id: int, gcs_uri: str, description: str, title: str, requirements: str,ext:str):
    try:
        async with AsyncSessionLocal() as db:
